...
| ⚙️ **Also fluent in** | Java, Python |
| 🚀 **Domain** | Ad Serving · Real-time Tracking · Distributed Systems |
| 🔬 **Currently deep in** | Cache frameworks, Kafka tuning, memory optimization |
| 💬 **Ask me about** | Concurrency, GC pressure, throughput vs. latency trade-offs |

</div>

---

## <img src="https://media.giphy.com/media/iY8CRBdQXODJSCERIr/giphy.gif" width="28"> &nbsp;Core Languages

<div align="center">

<img src="https://skillicons.dev/icons?i=go&theme=dark" width="65" alt="go"/>
...
<img src="https://img.shields.io/badge/Python-TOOLING-3776AB?style=for-the-badge&logo=python&logoColor=white&labelColor=0F2027" alt="python"/>

</div>

---

## <img src="https://media.giphy.com/media/ZVik7pBtu9dNS/giphy.gif" width="28"> &nbsp;Skill Proficiency
...
<tr><td><b>ScyllaDB</b></td><td><code>█████████████████░░░</code></td><td><b>85%</b></td></tr>
<tr><td><b>Java</b></td><td><code>████████████████░░░░</code></td><td><b>80%</b></td></tr>
<tr><td><b>Redis</b></td><td><code>████████████████░░░░</code></td><td><b>80%</b></td></tr>
<tr><td><b>Docker</b></td><td><code>███████████████░░░░░</code></td><td><b>75%</b></td></tr>
...
<img src="https://img.shields.io/badge/Kafka-95%25-231F20?style=flat-square&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/Linux-90%25-FCC624?style=flat-square&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/ScyllaDB-85%25-3AA9E0?style=flat-square&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/Java-80%25-ED8B00?style=flat-square&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/Redis-80%25-DC382D?style=flat-square&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/Docker-75%25-2496ED?style=flat-square&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/Python-60%25-3776AB?style=flat-square&labelColor=0F2027" alt=""/>

</div>

---

## <img src="https://media.giphy.com/media/dWesBcTLavkZuG35MI/giphy.gif" width="28"> &nbsp;Technology Stack
...
<img src="https://skillicons.dev/icons?i=go,java,python,bash&theme=dark" alt="languages"/>

**Streaming, Cache & Storage**

<img src="https://img.shields.io/badge/Apache_Kafka-231F20?style=for-the-badge&logo=apachekafka&logoColor=white" alt=""/>
<img src="https://img.shields.io/badge/Redis-DC382D?style=for-the-badge&logo=redis&logoColor=white" alt=""/>
<img src="https://img.shields.io/badge/RocksDB-2E4053?style=for-the-badge&logo=databricks&logoColor=white" alt=""/>
<img src="https://img.shields.io/badge/ScyllaDB-3AA9E0?style=for-the-badge&logo=scylladb&logoColor=white" alt=""/>
<img src="https://img.shields.io/badge/MongoDB-47A248?style=for-the-badge&logo=mongodb&logoColor=white" alt=""/>
...
<img src="https://img.shields.io/badge/Microservices-6DB33F?style=for-the-badge&logo=spring&logoColor=white" alt=""/>
<img src="https://img.shields.io/badge/gRPC-244C5A?style=for-the-badge&logo=grpc&logoColor=white" alt=""/>
<img src="https://img.shields.io/badge/CI%2FCD-2088FF?style=for-the-badge&logo=githubactions&logoColor=white" alt=""/>
...
## <img src="https://media.giphy.com/media/QssGEmpkyEOhBCb7e1/giphy.gif" width="28"> &nbsp;Development Timeline
...
```
 ┌─ 2022 ──────────────────────────────────────────────────────────┐
 │  ● Entered the software industry — 15 May 2022                  │
 │  ● Started backend development                                  │
 │  ● Golang · Java · REST APIs · Git fundamentals                 │
 └─────────────────────────────────────────────────────────────────┘
                              │
 ┌─ 2023 ──────────────────────────────────────────────────────────┐
 │  ● High-throughput backend systems                              │
 │  ● Kafka producers & consumers at scale                         │
 │  ● Redis · ScyllaDB · RocksDB                                   │
 │  ● Event-driven pipelines and real-time logging                 │
 └─────────────────────────────────────────────────────────────────┘
                              │
 ┌─ 2024 ──────────────────────────────────────────────────────────┐
 │  ● Performance optimization as a discipline                     │
 │  ● Distributed systems design                                   │
 │  ● Cache engines and in-memory data structures                  │
 │  ● Profiling, GC tuning, allocation reduction                   │
 └─────────────────────────────────────────────────────────────────┘
                              │
 ┌─ 2025 ──────────────────────────────────────────────────────────┐
 │  ● Ad serving platform engineering                              │
 │  ● Kafka throughput & partition-level optimizations             │
 │  ● Memory optimization and zero-allocation hot paths            │
 │  ● System design ownership across services                      │
 └─────────────────────────────────────────────────────────────────┘
                              │
 ┌─ CURRENT (2026) ────────────────────────────────────────────────┐
 ...
 │  ★ Golang performance engineering                               │
 └─────────────────────────────────────────────────────────────────┘
```

<div align="center">

<img src="https://img.shields.io/badge/2022-Foundations-4B6584?style=for-the-badge&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/2023-Scale-2C5364?style=for-the-badge&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/2024-Optimization-1F6F8B?style=for-the-badge&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/2025-Ad_Platform-00ADD8?style=for-the-badge&labelColor=0F2027" alt=""/>
<img src="https://img.shields.io/badge/2026-Performance_Engineering-7B42BC?style=for-the-badge&labelColor=0F2027" alt=""/>
...
<img src="https://img.shields.io/badge/Industry_Start-15_May_2022-00ADD8?style=for-the-badge&labelColor=0D1117" alt=""/>
<img src="https://img.shields.io/badge/Active_Years-5-7B42BC?style=for-the-badge&labelColor=0D1117" alt=""/>
...
<table>
<tr>
<td align="center"><h3>122</h3><sub>Commits analysed</sub></td>
<td align="center"><h3>93</h3><sub>Reviewed PRs merged</sub></td>
<td align="center"><h3>76%</h3><sub>Merged via code review</sub></td>
<td align="center"><h3>4</h3><sub>Promotion environments</sub></td>
</tr>
</table>
...
| Theme | Share | Distribution |
|:--|:--|:--|
| Validation & input hardening | 14% | `███████░░░░░░░░░░░░░` |
| Performance & optimization work | 11% | `██████░░░░░░░░░░░░░░` |
| Logging & observability | 12% | `██████░░░░░░░░░░░░░░` |
| Revenue / billing correctness | 9% | `█████░░░░░░░░░░░░░░░` |
| Attribution pipelines | 8% | `████░░░░░░░░░░░░░░░░` |
| Capping & rate control | 6% | `███░░░░░░░░░░░░░░░░░` |
| Kafka streaming & topics | 5% | `███░░░░░░░░░░░░░░░░░` |
| Release, versioning & sync | 20% | `██████████░░░░░░░░░░` |
...
### Yearly Activity Curve

</div>

```
 Commits (relative intensity)
 2022  ████████░░░░░░░░░░░░  ramp-up · fundamentals
 2023  ██████████████░░░░░░  high-throughput systems
 2024  █████████████████░░░  optimization & distributed work
...
## <img src="https://media.giphy.com/media/UVG0BN8TOMKkPOJS6e/giphy.gif" width="28"> &nbsp;My Journey
...
**2023 — Meeting real traffic.**
Moved onto systems where volume stopped being theoretical. Kafka producers and consumers, Redis for hot state, ScyllaDB and RocksDB for durable high-write paths. Learned that throughput problems and correctness problems look identical at 3 a.m. and must be told apart quickly.

**2024 — Optimization as a job, not a chore.**
Started treating performance as a first-class deliverable. Profiling, allocation reduction, cache design, and the constant negotiation between memory footprint and latency. This is where distributed systems stopped being a buzzword and became a set of trade-offs I could reason about.

**2025 — Owning an ad serving surface.**
Delivery, tracking, attribution, capping — real-time paths where a millisecond and a rupee are the same unit. Tuned Kafka pipelines, cut memory on hot paths, and moved from implementing designs to proposing them.

**2026 — Performance engineering.**
Currently focused on high-TPS systems, cache framework design, and squeezing predictable behaviour out of Go at the edges: GC pressure, goroutine scheduling, lock contention, and the tail of the latency distribution nobody looks at until it's on fire.
